...
fn recurse_hashless<'a>(
    ...
    'added: for (_added_transformed, added, add_ix) in unique_addeds {
        let aps = ArticulationPoints::from_added(added);
        ...
        for removed in all_removed {
            let partial_canonical_removed = Transformed::from_cropped_canonical_only(
